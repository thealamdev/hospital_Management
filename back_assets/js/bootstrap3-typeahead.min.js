! function(t, e) {
    ...
    t.fn.typeahead = function(s) {
        ...
        themes: {
            bootstrap3: {
                menu: '<ul class="typeahead dropdown-menu" id="opd_patient_ul" role="listbox"></ul>',
                item: '<li onclick="set_all_info()"><a class="dropdown-item" href="#"  role="option"></a></li>',
                itemContentSelector: "a",
                headerHtml: '<li class="dropdown-header"></li>',
                headerDivider: '<li class="dropdown-divider" role="separator"></li>'
            },
            bootstrap4: {
