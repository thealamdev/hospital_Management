    ...
    <div class="section-wrapper">
      <div class="container">
        <div class="mt-sm-3 shadow-lg p-3 mb-5 rounded">  
         <form method="post" action="admin/doc_edit_post" enctype="multipart/form-data">
          <div class="row">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-10">
               <select class="custom-select select2"  name="marketing_officer_id" >
                ...
                {
                  if($marketing_officer_id==$value['id']){?>

                   <option selected="" value="<?=$value['id']?>"><?=$value['name']?> (<?=$value['designation']?>)</option>;
                 <?php   }
                 ?>
           ...
           <select class="custom-select select2"  name="doctor_type" >
            ...
            if($doctor_type==1)
              ...
              {?>
               ...
               <option selected="" value="1">MBBS</option>;
               <option value="2">Q/C</option>;
             <?php } else { ?>

               <option selected="" value="2">Q/C</option>;
               ...
               <select class="custom-select select2"  name="doc_cat" >
                ...
                foreach ($doc_cat as $key => $value)
                {
                  if($marketing_officer_id==$value['id']){?>
                   ...
                   <option selected value='<?=$value['category']?>#<?=$value['id']?>'><?=$value['category']?></option>
                 <?php   }
                 ?>


                 <option value='<?=$value['category']?>#<?=$value['id']?>'>$doctor_title ($doctor_degree)</option>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
           <input class="form-control" name="doc_name" value="<?php echo $doctor_title?>" id="doc_name" placeholder="Doctor Name" type="text">
         </div>
       </div>   
       <div class="form-group">
         <label for="email" class="col-sm-12 control-label">Details</label>
         <div class="col-sm-10">
           <input class="form-control" name="doc_experience" value="<?php echo $doctor_degree?>"  placeholder="Email" type="text">
         </div>
       </div>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
           <input class="form-control" name="mobile_no" value="<?php echo $doc_mobile_no?>" id="mobile_no" placeholder="Mobile No" type="text">
         </div>
       </div>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
           <input class="form-control" value="<?=$address?>" name="address" id="address" placeholder="Address" type="text">
         </div>
       </div>
       ...
       <div class="form-group">
        ...
        <div class="fileinput fileinput-new" data-provides="fileinput">
          <div class=" border border-secondary fileinput-new thumbnail" style="width: 200px; height: 150px; margin-left: 15px;">
            <img style="width: 100%;height: 100%" src="uploads/doctor_image/<?=$doc_img?>" alt="...">
          </div>
