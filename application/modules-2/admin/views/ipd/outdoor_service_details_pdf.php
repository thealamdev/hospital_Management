...
<body style="color:#000; text-align: center;">
 ...
 <table style="padding-top:20px;  margin-left:5px; width:230px; text-align: center;font-size:12px ">
  <tr>
   <th style="text-align: left"><b>Reg No :</b> <span style="font-weight:normal"><?=$outdoor_service_order_info[0]['reg_id'];?></span></th>
 </tr>

 <tr>
   <th style="text-align: left"><b>Patient Name :</b> <span style="font-weight:normal"><?=$outdoor_service_order_info[0]['patient_name'];?></span></th>
 </tr>

  <tr>
   <th style="text-align: left"><b>Mobile No :</b> <span style="font-weight:normal"><?=$outdoor_service_order_info[0]['mobile_no'];?></span></th>
 </tr>

            <!-- <tr>
               <th style="text-align: left">Purchage Code: <span style="font-weight:normal"><?=$sell_details[0]['sell_code'];?></span></th>
             </tr> -->

             <tr>
               <th style="text-align: left">Date: <span style="font-weight:normal"><?=date('d M,Y h:i a',strtotime($outdoor_service_order_info[0]['created_at']))?></span></th>
             </tr>
             ...
             <table style="text-align:center; border-collapse: collapse;font-size: 12px; width:400px; margin-left:10px; margin-top:20px;margin-bottom:20px" class="table">
              <thead>
                <tr>
                  ...
                  <th style="border: #000 solid 1px;text-align:left;padding:0px 15px">Service Name</th>
              ...
              <tbody>
               <?php foreach ($outdoor_service_order_info as $key => $row) { ?>
                 <tr>
                   ...
                   <td align="" style="padding:0px!important;border: #000 solid 1px;"><?=$row['service_name'];?></td>
                   <td align="" style="border: #000 solid 1px;"><?=$row['qty'];?>
                 </td>
                 <td align="" style="border: #000 solid 1px;"><?=number_format($row['price'],2);?>&nbsp;৳ 
                 </td>
                 <td align="" style="border: #000 solid 1px;"><?=number_format(($row['price']*$row['qty']),2);?>&nbsp;৳ 
                 </td>
               </tr>
             <?php } ?>
           </tbody>
         ...
         <div style=" padding-bottom:10px" class="row">
          ...
          <tr>
           ...
           $net_total=$row['total_amount']-$row['total_discount']+$row['total_vat'];
           $due=$net_total-$row['total_paid'];
                         // echo $due;
           if($due<=0)
           {
     ...
     <tr>
      ...
      <td style="text-align: left">  : <?=number_format($row['total_amount'],2);?>&nbsp;৳</td>
    </tr>
    <tr>
      <th style="text-align: left"><b>Vat (+)</b></th>
      <td style="text-align: left">: <?=number_format($row['total_vat'],2);?> &#x9f3</td>
    </tr>
    <tr>
      <th style="text-align: left"><b>Discount (-)</b></th>
      <td style="text-align: left">: <?=number_format($row['total_discount'],2);?> &#x9f3</td>
    </tr>

    <tr>
      <th style="text-align: left"><b>Net Total</b>  </th>
      <td style="text-align: left">:  <?=number_format($net_total,2);?>&nbsp;৳</td>
    </tr>

    <tr>
      <th style="text-align: left;border-bottom:1px solid #ebebeb;"><b>Amount Paid</b></th>
      <td style="text-align: left">  :  <?=number_format($row['total_paid'],2);?> &#x9f3</td>
    </tr>

    <tr>
      <th style="text-align: left;border-bottom:1px solid #ebebeb;"><b>Due</b></th>
      <td style="text-align: left">  :  <?=number_format($due,2);?> &#x9f3</td>
