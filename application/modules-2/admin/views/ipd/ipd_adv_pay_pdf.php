...
<body style="color:#000; text-align: center;">
  ...
  <?php if ($due_info != null ) {?>

    <table class="farhana-table-2">
      <tr>
       <td   class="table-1-col-1"></td>
       <td   class="table-1-col-1"><p >Advance Receipt</p></td>
       <td   class="table-1-col-1"></td>
     </tr>
   </table>
   ...
   <tr>
     <th style="text-align: left">Invoice No: <span style="font-weight:normal"><?=$ipd_final_bill[0]['invoice_order_id'];?></span></th>
   </tr>

   <tr>
     <th style="text-align: left">Date: <span style="font-weight:normal"><?=date('d-m-Y h:i a',strtotime($patient_info[0]['created_at']))?></span></th>
   </tr>
   ...
   <table style="text-align:center; border-collapse: collapse;font-size: 12px; width:400px; margin-left:10px; margin-top:20px;margin-bottom:20px" class="table">
    <thead>
      <tr>
        ...
        <th style="border: #000 solid 1px;text-align:left;padding:0px 15px">Date</th>
        <th style="border: #000 solid 1px;text-align:left;padding:0px 15px">Advance Amount</th>
    ...
    <tbody>
     ...
     foreach ($due_info as $key => $row) { 
      ...
      <tr>
       ...
       <td align="" style="border: #000 solid 1px;"><?=date('d-m-Y h:i a',strtotime($row['created_at']));?>
       <td align="right" style="padding:0px!important;border: #000 solid 1px;"><?=$row['advance_payment'];?></td>
