...
<div class="col-md-12" style="border-bottom:#000 solid 1px">
                  ...
                  <!-- Table row -->
                    ...
                    <div class="width:100%">
					<p style="text-align:center;font-size:14px;color:#000;font-weight:bold;"> Report of IPD Operation Collection Between <?php echo $start_date?> to <?php echo $end_date?> </p>
