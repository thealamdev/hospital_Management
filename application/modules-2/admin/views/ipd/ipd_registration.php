...
<script type="text/javascript">
  ...
  $('#ipd_form').on('submit', function() {
    ...
    // alert(parseInt($('#adm_fee').val())); return false;

    if (parseInt($('#adm_fee').val()) > parseInt($('#adm_fee_paid').val()) && parseInt($('#adv_pay').val()) > 0  ) {

      alertify.alert("<b>First Pay Full Admission Fee, Then Advance Payment can possible</b>");
      return false;
    }
