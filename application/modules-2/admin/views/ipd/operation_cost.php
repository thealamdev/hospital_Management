...
<div class="section-wrapper">
 ...
 <div class="card my-3 no-b">
  <div class="card-body">
    <form method="POST" action="admin/operation_cost_day_wise_report" target="_blank">
    <div class="form-row">
...
<div class="card my-3 no-b">
  <div class="card-body">
   <h4 align="center">Today Operation Cost</h4>
       ...
       <tr>
        ...
        <td align="center">
          <?php if($value1['price']-$value1['discount'] <= $value1['cost_paid']) {
            ...
            <br><a class="btn btn-sm btn-primary" href="admin/one_click_payment_operation_cost/<?=$value1["s_id"]?>">Pay</a>
          <?php  }
          ?>
