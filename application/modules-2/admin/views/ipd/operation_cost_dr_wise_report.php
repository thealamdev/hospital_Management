          ...
          <div class="container">
           ...
           <div class="row pl-5 pr-5 my-3">
            <div class="col-12 table-responsive">
              <p style="text-align:center;font-size:14px;color:#000;font-weight:bold;"> Report of Operation Cost Between <?php echo $from_date?> to <?php echo $end_date?><br></p>
              ...
              <?php if($doc_id=="all"){ 
                ...
                foreach ($doc_list as $key => $value) {
                 ...
                 <p style="text-align:center;font-size:14px;color:#000;font-weight:bold;"><?=$value['doctor_title']?></p>
                 ...
                 <tbody>
                   ...
                   <?php  foreach ($service_info as $key1 => $value1) {


                    if($value['doctor_id']==$value1['operated_id'])
                    { 
