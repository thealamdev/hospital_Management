   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
         <div class="card-title">Date Wise Other Income Report</div>
         <form method="POST" action="admin/other_income_report_date_wise" target="_blank">
           <div class="form-row">
    ...
    <h4 align="center">Today Other Income Report</h4>
...
<div class="card my-3 no-b">
  <div class="card-body">
    ...
    <tbody>
      ...
      foreach($inc_info as $key => $value1)
      {
        ...
        <tr>
         ...
         <td align="right"><?=$value1['operator_name']?></td>
         <td align="right"><?=$value1['inc_exp_ref']?></td>
         <td align="right"><?=date($value1['created_at'])?></td>
