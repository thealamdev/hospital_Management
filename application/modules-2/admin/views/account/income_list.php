   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
          <div class="row">
            <form method="post" action="admin/add_income_post">
              <div class="form-row">
               ...
               <div class="col-md-2">
                 ...
                 <select class="custom-select select2 form-control" name="acc_head" required="" id="acc_head" required>
                   ...
                   <?php 
                   foreach ($acc_head_info_inc as $key => $acc_head){  ?>
            ...
            <div class="col-md-2 form-group">
              <label for="income_ref">Income Ref:</label>
              <input id="income_ref" required type="text" name="income_ref" class="form-control ui-autocomplete-input" autocomplete="off">  
            </div>

            <div class="col-md-2 form-group">
              <label for="amount">Amount:</label>
              <input id="amount" value="<?=number_format(0,2,'.', '');?>"  type="text" name="amount" class="form-control ui-autocomplete-input" autocomplete="off">  
            </div>
            ...
            <div class="form-group ml-4 mt-2">
              ...
              <form method="POST" action="admin/income_list_date_wise" target="_blank">
   ...
   <script type="text/javascript" language="javascript" >  
     $(document).ready(function(){ 
      ...
      var dataTable = $('#test_table').DataTable({  
       ...
       "order":[],  
       "ajax":{  
        url:"<?php echo base_url()?>"+'admin/income_list_dt/',  
        type:"POST"
      },  
      "columnDefs":[  
      {  
