   ...
   <div id="app">
      ...
      <div class="page has-sidebar-left height-full">
         ...
         <div class="section-wrapper">
            ...
            <form class="form-inline" method="POST" action="admin/headwise_income_expense_report_details" target="_blank">
                     
             
               <div class="row">
                  <div class="col-md-3">
                     <select class="custom-select select2 form-control" name="head_id" id="inc_exp" required>
                    <option value="0">Select Type</option>
                     <option value="all">All</option>
                    
                    <?php 
                    foreach ($all_head as $key => $value) { ?>
