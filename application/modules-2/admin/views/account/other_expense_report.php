   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
         <div class="card-title">Date Wise Other Expense Report</div>
         <form method="POST" action="admin/other_expense_report_date_wise" target="_blank">
           <div class="form-row">
    ...
    <h4 align="center">Today Other Expense Report</h4>
