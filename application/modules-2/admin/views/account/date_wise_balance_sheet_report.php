    ...
    <?php if($cat=="ipd" || $cat=="acc") { ?>
      ...
      <tbody>
        ...
        <tr >
          ...
          <?php $total_indoor_expense+=$indoor_discount_expense[0]['discount']+$operation_expense[0]['paid_cost'];?>
        ...
        <tr >
          ...
          $temp=($total_n_i-$indoor_total_paid[0]['paid_due'])*(-1);
          ?>
        ...
        <tr>
          ...
          <td align="right"><?=number_format($indoor_total_paid[0]['paid_due']-$indoor_advance_payment[0]['advance_payment']-$indoor_adm_fee_income_today[0]['admission_fee_paid'], 2, '.', '');?></td>
        </tr> 
...
<tr >
  ...
  <?php $total_indoor_expense+=$indoor_diag_discount_expense[0]['discount']; ?>
