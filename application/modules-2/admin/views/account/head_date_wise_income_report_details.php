...
<div class="col-md-12" style="border-bottom:#000 solid 1px">
    ...
    <tr>
            ...
            $due=0;
                 ...
                 <?php if($value['paid_by']==1){ ?>

                  <td>Cash</td>  

                  <?php } else if ($value['paid_by']==2) { ?>           
                      <td>Bank Acc. No: <?=$value['bank_acc_no']?><br/>Check No: <?=$value['check_no']?><br/>Check Pass Date: <?=$value['check_pass_date']?><br/>Ref No: <?=$value['reference']?><br/></td>

                      <?php } else { ?>

                        <td>Bkash No: <?=$value['bkash_no']?><br/>Tx Id: <?=$value['tx_id']?><br/></td>
