...
<body style="color:#000; text-align: center;">
  ...
  <div class="container">
    <div  class="row">
      ...
      <span style="text-align: center;margin-left: -70px;font-size: 18px;font-weight: bold;">Patient Report File Tag</span>
      <table class="farhana-table-3">
        <tr><td><b>Bill No: </b><label><?=$patient_order_info[0]['test_order_id']?></label></td><td><b>Date: </b><label><?=date("d-m-Y h:i:s", strtotime($patient_order_info[0]['created_at']))?></label></td>
        </tr>

        <tr><td style="text-align: left"><b>Patient Name: </b><label><?=$patient_info[0]['patient_name']?></label></td><td class="text-center" ><b>Age: </b><label><?=$patient_order_info[0]['age']?></label></td>
        </tr>

        <tr><td style="text-align: left"><b>Sex: </b><label><?=$patient_info[0]['gender']?></label></td>
          <td><b>Mob: </b><label><?=$patient_info[0]['mobile_no']?></label></td>
        </tr>

        <tr><td style="text-align: left"><b>Dr. Name: </b><label><?=$patient_order_info[0]['ref_doc_name']?></label></td>
        </tr>
