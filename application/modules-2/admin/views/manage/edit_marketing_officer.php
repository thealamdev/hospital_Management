   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      <div class="card my-3 no-b">
        <div class="card-body">
          <div class="container">
            <form action="admin/edit_marketing_officer_post/<?=$marketing_officer_list[0]['id']?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                 ...
                 <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8"><input class="form-control form-control-sm"  type="text" id="officer_name" value="<?=$marketing_officer_list[0]['name']?>" name="officer_name" placeholder="Officer Name" required></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8"><input class="form-control form-control-sm"   type="text" id="designation" value="<?=$marketing_officer_list[0]['designation']?>" name="designation" placeholder="Designation"></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <textarea class="form-control form-control-sm" id="description" name="description"><?=$marketing_officer_list[0]['description']?></textarea>
                    </div>
                  </div>
                </div>
                   ...
                   <div class="col-md-8">
                     <div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class=" border border-secondary fileinput-new thumbnail" style="width: 200px; height: 150px;">
                        <img style="width: 100%;height: 100%" src="uploads/officer_image/<?=$marketing_officer_list[0]['image']?>" alt="...">
                      </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8"><input class="form-control form-control-sm"   type="text" name="contact_no" value="<?=$marketing_officer_list[0]['contact_no']?>" id="contact_no" placeholder="Contact No" ></div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control form-control-sm" id="address" name="address"><?=$marketing_officer_list[0]['address']?></textarea>
                  </div>
                </div>
              </div>
