    ...
    <div  class="row">
      ...
      <table class="farhana-table-1" style="margin-left: 5px;">
        <tr>
          ...
          <td>
           <h1 class="" style="margin-bottom:5px; font-size:14px; text-align: center;margin-left: 5px;">
             <?=$hospital_title_eng_report?>
           </h1>

           <h1 style="margin-top:0px; font-size:13px; text-align: center;margin-left: 5px;">
...
<div style="float: left;border-left: 1px solid black;height:670px;margin-left: 1px;"><span style="margin-left: 5px;font-size: 35px;color: grey;">R<span style="font-size:20px;">X</span></span>  
</div> <br><br><br>
