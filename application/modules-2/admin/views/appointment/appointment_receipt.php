...
<body style="color:#000; text-align: center;">
    ...
    <div  class="row">
      ...
      <table class="farhana-table-1">
        <tr>
          ...
          <td>
           <h1 class="" style="margin-bottom: 2px; font-size:14px; text-align: center;margin-left: 5px;">
             <?=$hospital_title_eng_report?>
           </h1>

           <h1 style="margin-top:5px; font-size: 13px; text-align: center;margin-left: 5px;">
  ...
  <table class="farhana-table-3">
    ...
    <tr><td style="text-align: left"><b>Patient Name: </b><label><?=$appointment_info[0]['patient_name']?></label></td><td class="text-center" > <td style="text-align: left"><b>Patient Type: </b><label><?=$appointment_info[0]['patient_type']?><td style="text-align: center"><b>Serial No:</b><?=$appointment_info[0]['serial_no']?> 
    </tr>

    <tr><td style="text-align: left"><b>Sex: </b><label><?=$appointment_info[0]['gender']?><b>/Age: </b><label><?=$appointment_info[0]['age']?></label></td> <td class="text-center" ></label></td>
   ...
   <tr><td colspan="2"><b>Appointment Id: </b><label><?=$appointment_info[0]['appointment_gen_id']?></label></td> <td><b>Appo Date & Time: </b><label><?=date("d-m-Y", strtotime($appointment_info[0]['appointment_date']))." ".date("h:i a", strtotime($appointment_info[0]['appointment_time']))?></label></td>
    </tr>
  </table>
...
<div class="static-data">
  ...
  <div style=" padding-bottom:5px" >
   <table style="margin-top:20px;margin-left:70px">
    ...
    <table class="farhana-table-5" style="margin-top:-60px;margin-left:145px !important;width:75%;margin-bottom: 50px;">
      <tr>
        <td rowspan="6"></td>
