...
<!-- /.right-sidebar -->
   ...
   <script type="text/javascript">
    ...
    function reset_summernote(argument) {
     $('#summernote').summernote('code', '<div class="bio-chemestry_without_border"></div>');
   }

   function old_format_summernote(argument) {
     $('#summernote').summernote('code', '<div class="bio-chemestry"><table class="farhana-table-4"><tbody><tr><td><?php echo $sub_test_title?></td><td></td><td></td><td><br></td></tr></tbody></table></div>');
   }
