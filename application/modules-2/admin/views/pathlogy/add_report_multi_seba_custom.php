 ...
 <div class="page has-sidebar-left height-full">
  ...
  <div class="section-wrapper">
    <div class="card my-3 no-b">
      <div class="card-body">
        <div class="container">
          <form action="admin/report_publish_multi_custom/<?=$specimen_id?>/<?=$payment_status?>" method="POST" class="ipd_form">
            ...
            <input type="hidden" value="<?php echo $store_group_id?>" name="store_group_id"/>
            <div class="row">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <textarea id="summernote" name="mresult_combine">

                      <?php
                      if($multi_result_val[0]['mresult_combine'] != "")
                      {
                        $report_val=trim($multi_result_val[0]['mresult_combine']);
                        echo $report_val.$test_template;
                      }
                      else
                        { ?>
                        </br></br></br></br></br></br>
