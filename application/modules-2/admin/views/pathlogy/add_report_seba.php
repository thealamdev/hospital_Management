 ...
 <div class="page has-sidebar-left height-full">
  ...
  <div class="section-wrapper">
    <div class="card my-3 no-b">
      <div class="card-body">
        <div class="container">
          <form action="admin/report_publish" method="POST" class="ipd_form">
            <input type="hidden" value="<?php echo $ipathologoy_id?>" name="pathologoy_id"/>
            <div class="row">
              ...
              <div class="col-md-12">
               ...
               <div class="form-group"> 
                <div class="row">
                  <label for="" class="col-md-4 text-right">Group Name</label>
                  <div class="col-md-8"><input class="form-control form-control-sm" value="<?php echo $igroupid?>" readonly type="text" name="group_id" placeholder="" required></div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <label for="" class="col-md-4 text-right">Test Name</label>
                  <div class="col-md-8"><input class="form-control form-control-sm" value="<?php echo $itestid?>" readonly  type="text" name="ref_doc_name_t" placeholder="" required></div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <label for="" class="col-md-4 text-right">Sepcimen</label>
                  <div class="col-md-8"><input class="form-control form-control-sm" value="<?php echo $ispeciman?>"  type="text" name="speciman"  readonly placeholder="" required></div>
                </div>
              </div>	
              <div class="form-group">
                <div class="row">
                  <label for="" class="col-md-4 text-right">Delivery Date</label>
                  <div class="col-md-8"><input class="form-control form-control-sm" type="text" value="<?php echo date('d-m-Y', strtotime($pdate. ' + 2 days'));?>" name="delievry_date" placeholder="<?php echo date('d-m-Y', strtotime($pdate. ' + 2 days'));?>" ></div>
                </div>
              </div>

              <div class="form-group">
                <div class="row">
                  <label for="" class="col-md-6 text-right">Report Details</label>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    <textarea id="summernote" name="result">
                    </br></br></br></br></br></br>  
                    ...
                    <div  class="container-middle">
                      <table style=" border: 1px solid black; font-size:20px; margin-left: 46px; width: 839px; border-radius: 15px 15px 0 0 !important;padding: 3px; border-bottom: none;">
                        <tr>
                          ...
                          <td><b>Date: </b><?php echo date('d.m.Y h:i a', strtotime($padate));?></td>
                    ...
                    <table style=" border: 1px solid black; font-size:20px; margin-left: 46px; width: 839px; border-radius: 0 0 15px 15px !important;padding: 3px; border-top: none">
                      ...
                      <tr><td><b>Dr: </b><?php echo $ref_doctor_name.' '.$designation?></td></tr>

                      <tr>
                        <td><b>Specimen: </b><?php echo $specimen?></td>
                        <td><b>UHID: </b><?php echo $uhid_gen_id?></td>
