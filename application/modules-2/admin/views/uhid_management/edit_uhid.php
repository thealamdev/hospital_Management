...
<div class="section-wrapper">
  <div class="container">
   <div class="mt-sm-3 shadow-lg p-3 mb-5 rounded">
    <form id="my_form" action="admin/edit_uhid_post/<?=$uhid_info[0]['id']?>" enctype="multipart/form-data" method="post">
     <div class="row" tabindex="0">
      <div class="col-md-3">
       <div class="form-group">
        <label for="patient_name" class="col-sm-12 control-label">Patient Name</label>
        <div class="col-sm-12">
         <input class="form-control" name="patient_name" id="patient_name" required="" value="<?=$uhid_info[0]['patient_name']?>" placeholder="Patient Name" autocomplete="off" tabindex="1" type="text" autofocus="">
       </div>
     </div>
   </div>
   ...
   <div class="col-md-3">
     <div class="form-group">
      ...
      <div class="col-sm-12">
       <input autocomplete="off" class="form-control" name="mobile_no" id="mobile_no" value="<?=$uhid_info[0]['mobile_no']?>"  tabindex="2" placeholder="Mobile No" type="text">
     </div>
   </div>
 </div>
 ...
 <div class="col-md-3">
   ...
   <div class="form-group ml-3">
    <div class="form-check-inline">
     <input class="form-control col-sm-8" tabindex="3" autocomplete="off" id="age_dt" name="age" type="text" value="<?=$uhid_info[0]['age']?>" >
   </div>
 </div>
</div>
...
<div class="col-md-3">
 <div class="form-group">
  ...
  <div class="input-group ml-3">
   <input placeholder="dd/mm/yy"  autocomplete="off" type="text" value="<?=$uhid_info[0]['date_of_birth']?>" onchange="comp()" name="date_of_birth" id="date_of_birth" class="col-sm-7 date-time-picker form-control date_of_birth" data-options='{"timepicker":false,"format":"Y-m-d"}'   tabindex="6"/>
    ...
    <div class="col-sm-12">
     <select class="custom-select select2"  name="ref_doc" required>
      ...
      foreach ($doctor_list as $key => $value)
      {
        ...
        if($doctor_id==$uhid_info[0]['ref_doc_id'])
        {
...
<div class="col-md-3">
  <div class="form-group">
   ...
   <select class="custom-select select2" id="gender" name="gender" tabindex="9">
    <option <?php if ($uhid_info[0]['gender']=="Male"){ echo 'selected';}?> value="Male">Male</option>
    <option <?php if ($uhid_info[0]['gender']=="Female"){ echo 'selected';}?>  value="Female">Female</option>
    <option <?php if ($uhid_info[0]['gender']=="Others"){ echo 'selected';}?>  value="Others">Others</option>
  ...
  <div class="form-group">
    ...
    <div class="col-md-12">
     <select class="custom-select select2" name="blood_group" id="blood_group" required>
      ...
      <?php 
      foreach ($all_blood_group as $key => $blood){ if($blood['id']==$uhid_info[0]['blood_group'])
        { ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <div class="col-md-12"><input class="form-control form-control-sm" type="email" name="email" value="<?=$uhid_info[0]['email']?>" placeholder="" ></div>
  </div>
</div>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <div class="col-md-12">
      <textarea class="form-control" name="address" id="Address"><?=$uhid_info[0]['address']?></textarea>
    </div>
  </div>
</div>
...
<div class="form-group" id="upload_image">
 ...
 <div class="fileinput fileinput-new" data-provides="fileinput">
  <div class=" border border-secondary fileinput-new thumbnail" style="width: 150px; height: 100px; padding:  0 !important">
    <img height="100%" width="150%" src="uploads/uhid_patient/<?=$uhid_info[0]['patient_image']?>" alt="...">
  </div>
