...
<?php } else { ?>
  ...
  <tbody>
   ...
   <td align="" style="border: #000 solid 1px;"><?=$row['buy_qty']-$return_info[$key]['total_qty'];?>&nbsp;<?=$row['unit'];?>
 </td>


 <td align="" style="border: #000 solid 1px;"><?=number_format($row['buy_price'],2);?>&nbsp;৳ 
 </td>
 <td align="right" style="border: #000 solid 1px;"><?=number_format($row['buy_price']*($row['buy_qty']-$return_info[$key]['total_qty']),2);?>&nbsp;৳ 
 </td>
</tr>
<?php }   ?>
...
<div style=" padding-bottom:10px" class="row">
 ...
 <tr>
   ...
   if($total_price+$total_charge[0]['charge'] < $buy_details[0]['debit'])
   { 
...
<tr>
  <th style="text-align: left"><b>Net Total</b>  </th>
  <td style="text-align: left">:  <?=number_format($total_price+$total_charge[0]['charge'],2);?>&nbsp;৳</td>
</tr>

<tr>
  <th style="text-align: left;"><b>Amount Paid</b></th>
  <td style="text-align: left">  :  <?=number_format($buy_details[0]['debit']+$total_ret_paid[0]['total_paid'],2);?> &#x9f3</td>
</tr>
...
<?php  } else { ?>
  ...
  <tr>
    <th style="text-align: left"><b>Due</b></th>
    <td style="text-align: left"> :
      <?=number_format($total_price+$total_charge[0]['charge']-($buy_details[0]['debit']+$total_ret_paid[0]['total_paid']),2);?>&nbsp;৳
    </td>
  </tr>
...
<table style=" margin-top:200px; width:400px;padding-left:10px;   text-align: center;font-size:9px  ">
 <tr>
  ...
  <br><br><?php echo date('l jS \of F Y h:i:s A')?>
</th>
</tr>
</table>
</div>
