          ...
          <div class="container">
           ...
           <div class="row pl-5 pr-5 my-3">
            <div class="col-12">
              ...
              <p style="text-align:center;font-weight:bold">Sale Report from <?php echo date('d-m-Y', strtotime($from_date))?> to <?php echo date('d-m-Y', strtotime($end_date))?> (<?= $type_word == "others" ?  'Pharmacy Only' :  $type_word; ?>)</br>
                ...
                <table id="test_table" class="table table-bordered table-hover test_table_report">
                  ...
                  <tbody>
                    ...
                    foreach ($all_sell_product_list as $key => $value)
                    {
                      ...
                      $total_returnable+=$value['current_total_amount']-$value['current_total_charge'];
                      $total_returned+=$value['current_total_paid'];
                      ...
                      <tr>
                        ...
                        <td><span class=""><?=$value['current_total_charge'];?></span></td>
                        <td><span class=""><?=$value['current_total_amount']-$value['current_total_charge'];?></span></td>
                        <td><span class=""><?=$value['current_total_paid'];?></span></td>

                        <td><span class=""><?php if($value['patient_type']==1)
                        {
                          echo "Opd";
                        }
                  ...
                  <tfoot style="background:#ccc;font-weight: bold;">
                   <tr>
                    ...
                    <td><?php echo number_format($total_returnable,2,'.','')?> </td>
                    <td><?php echo number_format($total_returned,2,'.','')?> </td>
                    <td><?php echo number_format($total_charge,2,'.','')?> </td>
