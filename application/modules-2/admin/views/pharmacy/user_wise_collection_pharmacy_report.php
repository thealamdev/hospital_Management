          ...
          <div class="container">
           ...
           <div class="row pl-5 pr-5 my-3">
            <div class="col-12 table-responsive">
              <p style="text-align:center;font-size:14px;color:#000;font-weight:bold;"> Report of Pharmacy Collection Between <?php echo $from_date?> to <?php echo $end_date?> </p>

              <?php if($flag == "all"){ 

                foreach ($user_info as $key1 => $value1) {?>

                  <div  style="text-align: center; margin-bottom: 5px; color:red;"><?=$value1['username']?></div>
                  ...
                  <table id="test_table" class="table table-bordered table-hover table-striped test_table_report">
                    ...
                    <tbody>
                      ...
                      <?php  
                      foreach ($phar_order_info as $key => $value) {
                        if($value1['id'] == $value['operator_id']){
