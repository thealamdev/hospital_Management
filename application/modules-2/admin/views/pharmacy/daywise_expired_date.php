    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
          ...
          <form method="POST" action="admin/daywise_expired_date_report" target="_blank">
           <div class="form-row">
            ...
            <div class="form-group col-md-3">
             ...
             <label for="inputEmail4" class="col-form-label">Product List</label>
             <select class="custom-select select2" name="p_name">
