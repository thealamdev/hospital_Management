                ...
                <div class="col-md-10 offset-md-2">
                 <form  action="admin/update_cust_payment/<?=$sell_details[0]['sell_id']?>/<?=$sell_details[0]['cust_id']?>" method="POST" id="my_form">
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <input style="text-align: right" name="discount" id="discount" autocomplete="off" onkeyup="addinput();" value="<?=number_format(0,2,'.','')?>" class="form-control"></td>
                    </tr>

                    <tr>
                      <td colspan="5"align="right"><button class="btn-xs btn-success" type="Button">Grand Due</button></td>
                      <td><input autocomplete="off" style="text-align: right" id="grand_due" readonly  value="<?=number_format($ad,2,'.','')?>" class="form-control" type="number" name="grand_due"></td>
                    </tr>

                    <tr>
                      <td colspan="5"align="right"><button class="btn-xs btn-success" type="Button">Discount Ref</button></td>
                      <td><input autocomplete="off" style="text-align: right"  class="form-control" type="text" name="discount_ref" ></td>
                    </tr> 
                    ...
                    <?php if($row['debit'] < $row['net_total'] && $return_info == null) {?>
                      ...
                      <tr><td colspan="5"align="right"><button class="btn-xs btn-success" type="submit">Pay</button></td><td><input autocomplete="off" style="text-align: right" value="<?=number_format(0,2,'.','')?>" class="form-control" type="text" name="update_payment_cust" id="update_payment_cust"></td></tr>
...
<script type="text/javascript">
  ...
  $('#my_form').submit(function () {
    ...
    var update_payment_cust = parseFloat($("#update_payment_cust").val());
    var due = parseFloat($("#due").val());
    var discount_due= Number(document.getElementById("discount").value);

    if(update_payment_cust > due)
    {
      alertify.alert("<b>Total Paid Cant Be Greater Than Net Total</b>");
    ...
    if(discount_due > due)
    {
      alertify.alert("<b>Discount Must be less than due</b>");
