	...
	function get_stock_chart() 
		{
			...
			var c_id=$("#c_id").val();
				...
				$.ajax({
					      type: 'POST',
					      cache: false,
					      url: "<?=base_url();?>admin/get_company_stock",
					      data: {c_id:c_id },
		...
		function stock_report_pdf(argument) {
			...
			window.open('<?=base_url();?>admin/company_wise_stock_details_pdf/'+c_id,'_blank','width=560,height=340,toolbar=0,menubar=0,location=0');
