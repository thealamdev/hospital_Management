...
<body style="color:#000; text-align: center;">
  ...
  <table class="farhana-table-2">
    <tr>
     ...
     <td   class="table-1-col-1"><p >Birth Certificate</p></td>
     <td   class="table-1-col-1"></td>
   </tr>
 </table>
 ...
 <table class="farhana-table-3">
  ...
  <tr><td style="text-align: left"><b>Child Description: </b></td>
  </tr>
...
<table class="farhana-table-3">
  ...
  <table class="farhana-table-3">
    ...
    </tr> <tr><td colspan="2"><b>Place of Birth: </b><label ><?=$birth_info[0]['date_of_birth']?></td> 
    </tr> 
  </table>
