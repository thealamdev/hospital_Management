	...
	function get_stock_chart() 
		{
			...
			var p_id=$("#p_id").val();
				...
				$.ajax({
					      type: 'POST',
					      cache: false,
					      url: "<?=base_url();?>admin/get_product_lab_stock",
					      data: {p_id:p_id },
		...
		function stock_report_pdf(argument) {
			...
			window.open('<?=base_url();?>admin/product_wise_lab_stock_details_pdf/'+p_id,'_blank','width=560,height=340,toolbar=0,menubar=0,location=0');
