    ...
    <div class="section-wrapper">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php if($is_ipd_patient==1){ ?>
                 ...
                 <input class="form-control" value="IPD Patient" readonly type="text">
               ...
               <?php } else{ ?>
                 ...
                 <input class="form-control" value="OPD Patient" readonly type="text">

               <?php } ?>

               <input class="form-control" id="ipd_patient_id" value="<?=$ipd_patient_id?>"  type="hidden">
               <input class="form-control" id="is_ipd_patient" value="<?=$is_ipd_patient?>"  type="hidden">
     ...
     <!--               <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" value="<?=$ipd_patient_id?>" readonly type="text">
