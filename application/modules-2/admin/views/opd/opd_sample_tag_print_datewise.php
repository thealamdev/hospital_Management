   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
     ...
     <div class="form-group ml-4 mt-4">
      <a href="admin/opd_sample_tag_print_selective" class="btn btn-info btn-md"><i class="fa fa-plus-square"></i>&nbsp;Sample Tag Print ID Wise</a>
    </div>
    ...
    <div class="card my-3 no-b">
      <div class="card-body">
       <div class="card-title">Print Sample Tag</div>
       <form method="POST" action="admin/opd_sample_tag_print_datewise_post" target="_blank">
         <div class="form-row">
