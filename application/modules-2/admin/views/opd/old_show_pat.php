    ...
    <div class="col-md-12" >
     ...
     <input type="hidden" value="<?=$quack_doc_id?>" id="quack_doc_id" name="quack_doc_id">
          ...
          <div class="col-md-8">
           ...
           <!--   <div class="col-md-3">
                <div class="form-group">
                    <label for="blood_group" class="control-label">Mobile No</label>
                    <input class="form-control" value="<?=$mobile_no?>" name="mobile_no" id="mobile_no"  readonly type="text">
              </div>
            </div> -->
        ...
        <div class="col-md-4">
          <div class="row">
             <div class="col-md-7">
                  <div class="form-group">
                    <!-- <label for="blood_group" class="control-label">Blood Group</label> -->
                    <input class="form-control" value="<?=$mobile_no?>" name="blood_group_title" id="blood_group_title"  readonly type="text">
              </div>
            </div>

            <div class="col-md-5">
               <div class="form-group">
                 <!-- <label for="patient_name" class="control-label">Patient Pic</label> -->
         <!-- <br> -->
        
                 <img src='uploads/patient_image/<?=$profile_img?>' style="width:150px;height:100px"/>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  //      alertify.confirm("Are you want to clear your cart?",
    ...
    $(document).on('click', '#save_button', function()
    {
      ...
      var total_discount=parseFloat($("#discount").val()).toFixed(2);
      var ref_doc_name=$("#ref_doc_name").val();
      var quack_doc_name=$("#quack_doc_name").val();

      var ref_doc_id=parseInt($("#ref_doc_id").val());
      var quack_doc_id=parseInt($("#quack_doc_id").val());

      var paid_amount =parseFloat($("#total_paid").val()).toFixed(2);
      var total_amount=parseFloat($("#total_amount").val()).toFixed(2);
      var vat=parseFloat($("#vat").val()).toFixed(2);


      var total_gross_com=parseFloat($("#total_c_o").val()).toFixed(2);

      
      // var discount_ref=$("#discount_ref").val();

      var net_total=parseFloat($("#net_total").val()).toFixed(2);

      var due=parseFloat($("#due").val()).toFixed(2);

      var total_c_o=parseFloat($("#total_c_o").val()).toFixed(2);
      ...
      // // var paid_amount=parseFloat(paid_amount).toFixed(2);
      // // var net_total=parseFloat(net_total).toFixed(2);
      ...
      $.ajax({
              ...
              method:"POST",
              dataType:"json",
              data:{vat:vat,patient_id:patient_id,total_discount:total_discount,paid_amount:paid_amount,total_amount:total_amount,total_c_o:total_c_o,quack_doc_name:quack_doc_name,ref_doc_name:ref_doc_name,ref_doc_id:ref_doc_id,quack_doc_id:quack_doc_id,due:due,net_total:net_total,total_gross_com:total_gross_com},
              success:function(data)
              {
