                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="acc_head" class="col-sm-12 control-label">Order Id: </label>
                                 <div class="col-md-10">
                                    <select class="custom-select select2 form-control" onchange="get_bill_info()" name="order_id"  id="order_id" required>
                                       <option value="0">Select Order Id</option>
                                       <?php 
                                          foreach ($all_opd_patient_id as $key => $order_id){  ?>
                                       <option value="<?=$order_id['id']?>"><?=$order_id['test_order_id']?></option>
                                       <?php } ?>
                                    </select>
                                 </div>
                              </div>
