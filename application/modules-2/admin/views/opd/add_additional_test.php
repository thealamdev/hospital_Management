   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      <div class="card my-3 no-b">
        <div class="card-body">
          <div class="container">
            <form action="admin/add_additional_test_post" method="POST" class="ipd_form">
              <div class="row">
                <div class="col-md-12">
                 <div class="form-group">
                  <div class="row">
                    <label for="" class="col-md-4 text-right">Additional Test Name</label>
                    <div class="col-md-8"><input class="form-control form-control-sm"  type="text" name="additional_test_name" placeholder="Additional Test Name" required></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8"><input class="form-control form-control-sm"   type="text" name="price" placeholder="Price" required></div>
                  </div>
                </div>
