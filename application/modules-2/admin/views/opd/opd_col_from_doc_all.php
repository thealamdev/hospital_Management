    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
         ...
         <form method="GET" action="admin/opd_col_from_doc_all_report" target="_blank">
           <div class="form-row">
            ...
            <div class="form-group col-md-3">
              ...
              <div class="input-group ml-3">
                <input autocomplete="off" required="" type="text" name="end_date" id="date_of_birth" class="col-sm-8 date-time-picker form-control date_of_birth"
                data-options='{"timepicker":false, "format":"Y-m-d"}' value=""/>
                <span class="input-group-append">
                  <span class="input-group-text add-on white">
                    <i class="icon-calendar"></i>
            ...
            <div class="form-group col-md-3">
             ...
             <select class="custom-select select2" name="doc_name">
              ...
              <option value="all_mbbs">All Mbbs</option>
              <option value="all_quack">All Q/C And Director</option>
