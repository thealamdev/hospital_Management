             ...
             <div class="row pl-5 pr-5">
              ...
              <div class="col-md-3">
                <table>
                  <tbody>
                     <tr>
                      <th>Booked By: <span><?=$patient_info[0]['operator_name']?></span></th>
                      
                    </tr>

                    <tr>
                     <th style="text-align: left"><b>Ref Doctor :</b> <span style="font-weight:normal">
                      ...
                      <?php foreach ($doctor_info_quack as $key => $value) {
                          ...
                          {?>
                            ...
                            <th style="text-align: left"><b>Quack Doctor :</b> <span style="font-weight:normal"><?=$value['doctor_title']?></span></th>
