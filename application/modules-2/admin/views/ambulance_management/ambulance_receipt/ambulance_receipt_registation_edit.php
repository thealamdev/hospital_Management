...
<body class="light">
  ...
  <div id="app">
    ...
    <div class="section-wrapper">
      <div class="container">
        <div class="mt-sm-3 shadow-lg p-3 mb-5 rounded">  
          <form method="post" action="admin/ambulance_receipt_edit_post" enctype="multipart/form-data">
            <div class="row">

            <input type="hidden" name="amb_reciept_id" value="<?php echo $amb_reciept_id?>"/>
            ...
            <div class="form-group">
             ...
             <div class="col-sm-7">
               <input class="form-control" name="trip_no"  value="<?php echo $trip_no;?>" id="trip_no" placeholder="Trip No" value="<?php echo $max_trip_no;?>" type="text" readonly>
             </div>
           </div>  
		   </div>
              <div class="col-md-3">
        ...
        $checkedUhid = "checked";
             ...
             <label for="user_name" class="col-sm-3 control-label">Patient Name</label>
              ...
              <div class="col-sm-9" id="otherpatient_id">
                <input class="form-control" readonly name="patient_name" value="<?=$patient_name?>" id="patient_name" placeholder="Name" type="text">
              </div>
            </div>
           </div>			
              <div class="col-md-3">
                ...
                <div class="col-sm-9">
                 <select class="custom-select select2"  name="ambulance_no" >
                  ...
                  {?>
                    ...
                    <option value="<?=$value['ambulance_id']?>" <?php if($value['ambulance_id'] == $ambulance_id){echo " selected";}?>><?=$value['ambulance_no']?> (<?=$value['gen_id']?>)</option>;
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="patient_mobile_no" value="<?php echo $patient_mobile_no?>" id="patient_mobile_no"  placeholder="Mobile No" type="text">
             </div>
           </div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="road_name"  value="<?php echo $road_name;?>" id="road_name" placeholder="Road Name" type="text">
             </div>
           </div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="distance"  value="<?php echo $distance;?>" id="distance" placeholder="Distance" type="text">
             </div>
           </div>
           </div>
   ...
   <!--         <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="total_recieve"  value="<?php echo $total_recieve;?>" id="total_recieve" placeholder="Total Recieve" type="text">
             </div>
           </div> -->
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="fuel_cost"  value="<?php echo $fuel_cost;?>" id="fuel_cost" placeholder="Fuel Cost" type="text">
             </div>
           </div>
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="road_cost"  value="<?php echo $road_cost;?>" id="road_cost" placeholder="Road Cost" type="text">
             </div>
           </div>
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="service_maintance_cost" value="<?php echo $service_maintance_cost;?>"  id="service_maintance_cost" placeholder="Service & Maintanance Cost" type="text">
             </div>
           </div>
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="comments"  value="<?php echo $comments;?>" id="comments" placeholder="comments" type="text">
             </div>
           </div>
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="driver_name"  value="<?php echo $driver_name;?>" id="driver_name" placeholder="Driver Name" type="text">
             </div>
           </div>
           </div>
              <div class="col-md-3">
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input class="form-control" name="driver_mobile_no"  value="<?php echo $driver_mobile_no;?>" id="driver_mobile_no" placeholder="Driver Mobile No" type="text">
             </div>
           </div>
           </div>
