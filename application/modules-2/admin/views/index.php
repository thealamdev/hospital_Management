    ...
    <header class=" relative nav-sticky">
      <div class="container-fluid ">
       <div class="row pt-2 pb-4">
        ...
        height: 170px; border: 4px solid #1f72d1" src="uploads/dashboard_img/<?=$this->session->userdata['logged_in']['dashboard_img']?>"></div>
      </div>
    </div>
  </header>
         ...
         <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
              <span class="dash-widget-bg3 dash-widget-bg8-cus"><i class="fa fa-money" aria-hidden="true"></i></span>
              <div class="dash-widget-info text-right">
                <h3><?=number_format($pharmacy_net_income[0]['paid_due'], 2, '.', '');?> BDT</h3>
                <span class="widget-title3 widget-title8">Total Phar. Collection <i class="fa fa-check" aria-hidden="true"></i></span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
              <span class="dash-widget-bg3 dash-widget-bg8-cus"><i class="fa fa-money" aria-hidden="true"></i></span>
              <div class="dash-widget-info text-right">
                <h3><?=number_format(($pharmacy_net_income[0]['paid_due']+$total_purchase_return_paid[0]['total_paid'])-($pharmacy_supplier_expense[0]['paid_due']+$total_sales_return_paid[0]['total_paid']), 2, '.', '');?> BDT</h3>
                <span class="widget-title3 widget-title8">Total Phar. Net Cash<i class="fa fa-check" aria-hidden="true"></i></span>
              </div>
            </div>
          </div>
<!-- 
...
<footer  class="main-footer text-right">2020 © Copyright Software Park BD (01624794910)</footer>
</div>
