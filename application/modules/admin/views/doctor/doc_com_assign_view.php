    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
          ...
          <form action="admin/comission_cancel_all/<?=$doctor[0]['doctor_id']?>" method="post">
            <div style="text-align: center;">

               <button class="btn-sm btn-danger" type="submit">Delete All</button>
