...
<div class="section-wrapper">
  <div class="container">
   <div class="mt-sm-3 shadow-lg p-3 mb-5 rounded">
    <form id="my_form" action="admin/add_death_certificate_post" enctype="multipart/form-data" method="post">
   ...
   <div class="col-md-3">
     <div class="form-group">
      ...
      <div class="col-sm-12">
       <input class="form-control" name="mother_name" id="mother_name" required="" placeholder="Mother Name" autocomplete="off" tabindex="1" type="text" autofocus="">
     </div>
   </div>
 </div>
 ...
 <div class="col-md-3">
   <div class="form-group">
    ...
    <div class="col-sm-12">
     <input class="form-control" name="father_name" id="father_name" required="" placeholder="Father Name" autocomplete="off" tabindex="1" type="text" autofocus="">
   </div>
 </div>
</div>
...
<div class="col-md-3">
 <div class="form-group">
  ...
  <div class="col-sm-12">
   <input autocomplete="off" class="form-control" name="place_of_birth" id="place_of_birth"  tabindex="2" placeholder="Place of Birth" type="text">
 </div>
</div>
</div>
...
<div class="col-md-3">
 <div class="form-group">
  <label for="date_of_birth" class="col-sm-12 control-label">Date of Death</label>
  <div class="input-group ml-3">
   <input placeholder="dd/mm/yy"  autocomplete="off" type="text" onchange="comp()" name="date_of_death" id="date_of_death" class="col-sm-7 date-time-picker form-control date_of_death"
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <div class="col-md-12"><input class="form-control form-control-sm" type="text" name="height" id="height" placeholder="" ></div>
  </div>
</div>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <div class="col-md-12"><input class="form-control form-control-sm" type="text" name="weight" placeholder="" ></div>
  </div>
</div>
...
<div class="col-md-3">
<div class="form-group">
    <label for="" class="col-md-4 text-right">Doctor Name</label><a href="admin/add_doc" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;" style="font-size:10px"> (ADD NEW)</a>
    <div class="col-md-12">
