...
<div class="section-wrapper">
  <div class="container">
   <div class="mt-sm-3 shadow-lg p-3 mb-5 rounded">
    <form id="my_form" action="admin/edit_death_certificate_post/<?=$birth_info[0]['id']?>" enctype="multipart/form-data" method="post">
...
<div class="col-md-3">
 <div class="form-group">
  ...
  <div class="input-group ml-3">
   ...
   <input autocomplete="off" class="form-control"  value="<?=$birth_info[0]['date_of_death']?>"  tabindex="2"  readonly type="text">
   <span class="input-group-append">
     <span class="input-group-text add-on white">
       <i class="icon-calendar"></i>
     </span>
