...
<body style="color:#000; text-align: center;">
    ...
    <div  class="row">
      ...
      <table>
        <tr>
          ...
          <td>
           <h1 class="" style="margin-bottom: 2px; font-size:18px; text-align: center;margin-left:15px;">
             <?=$hospital_title_eng_report?>
           </h1>

           <h1 style="margin-top: 0px; font-size: 16px; text-align: center;margin-left:15px;">
 ...
 <table style="padding-top:20px; float: left;  margin-left:5px; width:230px; text-align: center;font-size:16px;">
  <tr>
   <th style="text-align: left"><b>Sell Id :</b> <span style="font-weight:normal"><?=$sell_details[0]['cust_gen_id'];?></span></th>
 </tr>

 <tr>
   <th style="text-align: left"><b>Name :</b> <span style="font-weight:normal"><?=$sell_details[0]['cust_name'];?></span></th>
 </tr>
...
<div class="static-data">
  ...
  <?php if($return_info == null) { ?>
   ...
   <table style=" border-collapse: collapse;font-size:17px; width:450px; margin-left:10px; margin-top:20px;margin-bottom:20px" class="table">
    <thead>
      <tr>
...
<div style=" padding-bottom:10px" class="row">
 <table style="padding-top:5px;  margin-left:5px; width:200px; text-align: center;font-size:15px;">
  <tr>
