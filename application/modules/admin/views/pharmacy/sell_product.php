    ...
    <div class="section-wrapper">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-5">
            <form action="admin/insert_sell_data" method="post">
              <div class="card my-3 no-b">
                <div class="card-body">

                 <div class="form-check-inline ml-2 mt-4 ml-4">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" value="1"  onclick="pass_radio_val_opd()" name="optradio">opd patient
                  </label>
                </div>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" value="2" onclick="pass_radio_val_ipd()" name="optradio">ipd patient
                  </label>
                </div>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input  type="radio" class="form-check-input mb-4" value="3" onclick="pass_radio_val_phar_cust()" name="optradio">Phar Customer
                  </label>
                </div>

                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input checked type="radio" class="form-check-input mb-4" value="4" onclick="pass_radio_val_new()" name="optradio">New
                  </label>
                </div>

                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input  type="radio" class="form-check-input mb-4 ml-4" value="5" onclick="pass_radio_val_phar_uhid()" name="optradio">UHID
                  </label>
                </div>

                <div class="row" style="padding:15px;">
                  <div class="col-md-6 mb-4" id="customer_list_div" style="display: none;">
                    ...
                    <select id="customer_name" onchange="get_customer()"  name="cust_id" class="chosen-select custom-select select2 form-control" >
                      ...
                      <?php foreach ($customer_list as $row) { ?>
                        <option value="<?=$row['id'];?>"><?=$row['cust_gen_id'];?> (<?=$row['cust_name'];?>)</option>
                      <?php } ?> 
                  ...
                  <div class="col-md-6 mb-4" id="opd_customer_list_div" style="display: none">
                  ...
                  <div class="col-md-6 mb-4" id="ipd_customer_list_div" style="display: none">
                  ...
                  <div class="col-md-6 mb-4" id="uhid_customer_list_div" style="display: none">
                    ...
                    <select id="uhid_customer_name" onchange="get_customer_uhid()"   name="uhid_customer_id" class="chosen-select custom-select select2 form-control" >
                      ...
                      <?php foreach ($uhid_customer_list as $row) { ?>
                        <option value="<?=$row['id'];?>"><?=$row['gen_id'];?> (<?=$row['patient_name'];?>)</option>
                      <?php } ?> 
                    </select> 
                  </div>
