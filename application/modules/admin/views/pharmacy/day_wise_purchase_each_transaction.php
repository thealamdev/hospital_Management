    ...
    <div class="section-wrapper">
      <div class="card my-3 no-b">
        <div class="card-body">
         ...
         <form class="form-inline" method="POST" action="admin/day_wise_purchase_each_transaction_report" target="_blank">


           <div class="row">
            <div class="col-md-3">
             <select class="custom-select select2 form-control" name="company_id" id="inc_exp" required>
              <!-- <option value="0">Select Customer</option> -->
              <option value="all">All</option>

              <?php 
              foreach ($allcompany as $key => $value) { ?>
               <option value="<?=$value['id']?>"><?=$value['supp_name']?></option>
             <?php }
             ?>
           </select>
         </div>
