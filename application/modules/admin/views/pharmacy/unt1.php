...
<body>
	...
	<div style="margin:0 auto; margin-top:0px; font-size:9px;" class="row text-center">
		<div  class="col-lg-6 col-md-6 text-left">
			...
			<p> <b>Bill No</b> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;: <?=$buy_details[0]['bill_no'];?><label id="invoice"></label></p>
			<p style="margin-top:-15px"><b>Purchage Code</b>&nbsp; : <?=$buy_details[0]['buy_code'];?> <span style="margin-left: 40px"></span></p>
			<p style="margin-top:-15px"><b>Supplier Name &nbsp; &nbsp; &nbsp; &nbsp; </b>: <?=$buy_details[0]['supp_name'];?> <label id="patient_name"></label></p>
	...
	<div  class="col-lg-6 col-md-6 text-left"><p><b>Date</b>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; : <?php $only_date_array=explode(' ', $buy_details[0]['created_at']);
  ...
  <tbody>
  	 <tr >
                          ...
                          <td align=""><?=$row['buy_qty'];?>&nbsp;<?=$row['unit'];?>
                          </td>
                          <td align=""><?=number_format($row['buy_price'],2);?>&nbsp;৳ 
                          </td>
                          <td align=""><?=number_format(($row['buy_price']*$row['buy_qty']),2);?>&nbsp;৳ 
                          </td> 
                        </tr>
                        <?php } ?>
