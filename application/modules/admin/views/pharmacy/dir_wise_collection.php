    ...
    <div class="section-wrapper">
      <div class="card my-3 no-b">
        <div class="card-body">
          ...
          <form class="form-inline" method="POST" action="admin/dir_wise_collection_report" target="_blank">


           <div class="row">
            <div class="col-md-3">
             <select class="custom-select select2 form-control" name="dir_id" id="dir_id" required>
