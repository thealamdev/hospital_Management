           ...
           <div class="row pl-5 pr-5 my-3">
            <div class="col-12 table-responsive">
              ...
              <?php if($flag == "all"){ 
                ...
                foreach ($marketing_officer_info as $key1 => $value1) {?>

                  <div  style="text-align: center; margin-bottom: 5px; color:red;"><?=$value1['name']?> (<?=$value1['designation']?>) (<?=$value1['contact_no']?>)</div>
                  ...
                  <table id="test_table" class="table table-bordered table-hover table-striped test_table_report">
                    ...
                    <tbody>
                      ...
                      <?php  
                      foreach ($marketing_officer_wise_info as $key => $value) {
                        if($value1['id'] == $value['marketing_officer_id']){
                ...
                <tbody>
                  ...
                  foreach ($marketing_officer_wise_info as $key => $value) {
                    ...
                    <tr>
                     ...
                     <td align="right"><?=$value['vat']?></td>
                     <td align="right"><?=$value['discount']?></td>
                     <td align="right"><?=$value['doctor_title']?></td>
