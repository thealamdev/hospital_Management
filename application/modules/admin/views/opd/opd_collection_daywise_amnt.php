      ...
      <div class="card my-3 no-b">
        ...
        <table class="table table-bordered table-striped test_table_report">            
         ...
         <tfoot>
           <tr>
            <td colspan="5"></td>
            <td>Total Amount : <?php echo $toatl?></td>
            <td>Total Paid : <?php echo $toatlp?></td>
            <td>Total Due : <?php echo $due ?></td>
            <td>Total Discount : <?php echo $total_discount?></td>
            <td>Total VAT : <?php echo $total_vat?></td>
            <td>Total Commission : <?php echo $total_com?></td>
            <td>Total Commission Paid: <?php echo $total_com_paid?></td>
            <td>Total Net Cash: <?=$total_net_cash_in?></td>
            <td></td>
            <td></td>
