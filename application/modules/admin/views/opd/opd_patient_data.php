...
<body class="light">
  ...
  <div id="app">
    ...
    <div class="page has-sidebar-left height-full" style="background: #2B3467;border-top:1px solid white">
      <header class="accent-3 relative nav-sticky">
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      ...
      var dataTable = $('#test_table').DataTable({
        ...
        "order": [],
        "ajax": {
          url: "<?php echo base_url() ?>" + 'admin/opd_patient_data_dt/',
          type: "POST"
        },
        "columnDefs": [{
          "targets": [1, 6, 7, 8, 9],
