...
<head>
  ...
  <link rel="stylesheet" href="back_assets/css/bootstrap.min.css">
  ...
  <div class="row">
    ...
    foreach ($patient_order_info as $key => $value) { 
      ...
      <div class="col-md-4" style="margin-bottom: 25px;">
        <span style="margin-left: 60px;font-size: 18px;font-weight: bold;">Patient Report File Tag</span>
        <table class="farhana-table-3">
          <tr><td><b>Bill No: </b><label><?=$value['test_order_id']?></label></td><td><b>Date: </b><label><?=date("d-m-Y h:i:s a", strtotime($value['created_at']))?></label></td>
          </tr>

          <tr><td style="text-align: left"><b>Patient Name: </b><label><?=$value['patient_name']?></label></td><td class="text-center" ><b>Age: </b><label><?=$value['age']?></label></td>
          </tr>

          <tr><td style="text-align: left"><b>Sex: </b><label><?=$value['gender']?></label></td>
            <td><b>Mob: </b><label><?=$value['mobile_no']?></label></td>
          </tr>

          <tr><td style="text-align: left"><b>Dr. Name: </b><label><?=$value['ref_doc_name']?></label></td>
          </tr>

        </table>


        <?php if($step_size == 15) { $step_size=0; ?>
          <br><br>
        <?php } ?>
      </div>
