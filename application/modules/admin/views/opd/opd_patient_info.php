  ...
  $(document).ready(function()
  {
    ...
    $(document).on('click', '.add_this_test', function()
    {
      ...
      $.ajax({
        ...
        method:"POST",
        dataType:"html",
        data:{test_id:test_id,sub_test_id:sub_test_id, doc_com_per:doc_com_per,  test_name:test_name, test_price:test_price,quk_ref_com:quk_ref_com,quantity:quantity,type:type},
        success:function(data)
        {
