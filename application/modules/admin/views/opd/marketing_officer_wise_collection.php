   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
         <div class="card-title">Marketing Officer Wise Collection</div>
         <form method="POST" action="admin/marketing_officer_wise_collection_date_wise" target="_blank">
           <div class="form-row">
        ...
        <div class="form-group col-md-3">
          ...
          <div class="col-sm-10">
           <select class="custom-select select2"  name="marketing_officer_id" required="">
            <option value="">--Select--</option>
            <option value="all">All</option>
            <?php
            foreach ($marketing_officer_info as $key => $value)
            {
              ?>
