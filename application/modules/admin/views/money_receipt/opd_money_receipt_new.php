...
<body style="color:#000; text-align: center;">
 ...
 <table class="farhana-table-3">
  <tr><td colspan="2"><b>Bill No: </b><b><b><label id="invoice"><?=$test_info[0]['test_order_id']?></label></td><td><b><b>Date: </b><label id="date_time"><?=date("d-m-Y H:i:s", strtotime($test_info[0]['created_at']))?></label></td>
  </tr>
    <tr><td colspan="2"><b>Patient Name: </b><b><b><label id="patient_name"><?=$test_info[0]['patient_name']?></td>
  <tr><td style="text-align: left"><b>Sex: </b><b><b><label id="gender"><?=$test_info[0]['gender']?><b>   /  Age:</b><label id="age"><?=$test_info[0]['age']?></label></td> <td class="text-left" >
  ...
  <tr><td colspan="3" class="doctor-name"><b>Dr. Name: </b><b><b><label id="ref_by"><?=$test_info[0]['ref_doc_name']?></label></td>
  </tr>
...
<footer class="footer">
 ...
 <tr><td colspan="2" class="doctor-name"><b>Ref Dr. ID: </b><b><b><label id="quack_by">D-<?=$test_info[0]['quack_doc_id']?></label></td><td colspan="2" class="doctor-name">
  </tr>
