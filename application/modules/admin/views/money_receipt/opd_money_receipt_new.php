 ...
 <body>
   ...
   <div class="patient_details_wrapper">
     <div class="patient_left_details">
       ...
       <?php
        ...
        ?>
       <p class="details_width" style="margin-bottom: 4px;">Patient ID</p> <span><b>: <?= $test_info[0]['patient_id'] ?></b> </span><br>
   ...
   <!-- <div class="accounts_wrapper">
     ...
     <div class="payment_status_wrapper">
       <h2 style="text-align: center;font-size:20px;margin-bottom: -20px;">PAYMENT DETAILS</h2>
     </div>
   ...
   <div class="payments_wrapper">
     ...
     <div class="payment_auth_wrapper">
       ...
       <div class="payment_status" style="padding-right: 285px;">
         <?php if ($test_info[0]['payment_status'] == "paid") { ?>
           <img src="uploads/payment-status/paid_seal.jpg" width="100px" alt="uploads/hospital_logo/<?= $hos_logo ?>">
         <?php } else { ?>
           <img src="uploads/payment-status/due_seal.jpg" width="100px" alt="uploads/hospital_logo/<?= $hos_logo ?>">
         <?php } ?>
       </div>
     </div>
    ...
    <div style=" padding-bottom:5px">
     ...
     <div class="direction_wrapper">
       ...
       <!-- <p>Ref DR. ID: <?= $test_info[0]['quack_doc_id'] ?></p> -->
       ...
       <!--  <p style="text-align: center;font-size:14px">Developed By </p> -->
     </div>
   </div>
