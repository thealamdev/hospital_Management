 ...
 -->
  <div style="margin-top:2px;">
    <table class="farhana-table-3">
      ...
      <tr>
        <td><img style="border-radius: 20%;border:2px solid black; height: 100px; width: 100px; max-width: none !important;" src="uploads/uhid_patient/<?=$uhid_info[0]['patient_image']?>"></td>

        <td>
          <td colspan="2"><b>Name: </b><label><?=$uhid_info[0]['patient_name']?></label><br><b>UHID: </b><label><?=$uhid_info[0]['gen_id']?></label><br><b>Sex: </b><label><?=$uhid_info[0]['gender']?></label><br><b>Contact No: </b><label><?=$uhid_info[0]['mobile_no']?></label><br><b>Blood Group: </b><label><?=$uhid_info[0]['blood_group_title']?></label><br><b>Date of Birth: </b><label><?=date("d-m-Y", strtotime($uhid_info[0]['date_of_birth']))?></label></td>
      </tr>
    </table>
  </div>
