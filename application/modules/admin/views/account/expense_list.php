    ...
    <div class="section-wrapper">
      <div class="card my-3 no-b">
        <div class="card-body ml-3">
          ...
          <div class="row">
            <form method="post" action="admin/add_expense_post">
              <div class="form-row">
                <div class="col-md-2">
                 ...
                 <select class="custom-select select2 form-control" name="acc_head" id="acc_head" required>
                   ...
                   <?php 
                   foreach ($acc_head_info_exp as $key => $acc_head){  ?>
            ...
            <div class="col-md-2 form-group">
              ...
              <textarea id="income_expense_purpose"  type="text" name="income_expense_purpose" rows=1 class="form-control ui-autocomplete-input" autocomplete="off"></textarea>

            </div>
            <div class="col-md-2 form-group">
              <label for="expense_ref">Expense Ref:</label>
              <input id="expense_ref" required type="text" name="expense_ref" class="form-control ui-autocomplete-input" autocomplete="off">  
            </div>
            <div class="col-md-2 form-group">
              <label for="amount">Amount:</label>
              <input id="amount" value="<?=number_format(0,2,'.', '');?>" required type="text" name="amount" class="form-control ui-autocomplete-input" autocomplete="off">  
            </div>
            ...
            <div class="col-md-4 form-group">
              ...
              <div class="form-check-inline ">
                <label class="form-check-label">
                 ...
                 <div align="right" class="col-md-2 form-group">
              ...
              <div class="form-group ml-4 mt-4">
                ...
                <form method="POST" action="admin/expense_list_date_wise" target="_blank">
                  <div class="form-row mt-3">
                    ...
                    <div class="form-group col-md-3">
                     ...
                     <select class="custom-select select2" name="income_head_id">
   ...
   <script type="text/javascript" language="javascript" >  
     $(document).ready(function(){ 
      ...
      var dataTable = $('#test_table').DataTable({  
       ...
       "order":[],  
       "ajax":{  
        url:"<?php echo base_url()?>"+'admin/expense_list_dt/',  
        type:"POST"
      },  
      "columnDefs":[  
      {  
