    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
          ...
          <form method="post" action="admin/acc_head_add_post">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input class="form-control" name="acc_head_title" id="acc_head_title" placeholder="Acc Head Title" type="text">
                 </div>
               </div>   
               <div class="form-group">
                 <label for="email" class="col-sm-12 control-label">Acc Code</label>
                 <div class="col-sm-10">
                   <input class="form-control" name="acc_code"  placeholder="Acc Code " type="text">
                 </div>
               </div>
             ...
             <!--  <div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <input class="form-control" name="open_balance"  placeholder="Opening Balance" type="text">
                 </div>
               </div> -->
             </div>
           </div>
