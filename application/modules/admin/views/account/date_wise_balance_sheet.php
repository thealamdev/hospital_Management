 ...
 <div class="card my-3 no-b" id="balance_div">
   ...
   if($cat=='opd' || $cat=='acc'){ ?>
    ...
    <tbody>
      ...
      $total_n_i+=$outdoor_total_amount[0]['total_amount']+$outdoor_vat_income[0]['vat']-$outdoor_discount_expense[0]['discount'];

      $due=$total_n_i-$outdoor_total_paid[0]['paid_amount'];
      ...
      $t_f_d+=$outdoor_discount_expense[0]['discount'];
     ...
     <tr >
      ...
      <td align="right"><?=number_format($outdoor_total_paid[0]['paid_amount'], 2, '.', '');?></td>
    ...
    <tr >
      ...
      <td align="right" style="border-bottom: 3px solid #000 !important;"><?=number_format($outdoor_net_income[0]['paid_due']-$outdoor_total_paid[0]['paid_amount'], 2, '.', '');?></td>

      <?php  $t_d_c+=$outdoor_net_income[0]['paid_due']-$outdoor_total_paid[0]['paid_amount']; ?>
...
<tbody>
  ...
  $due=$total_n_i-$indoor_total_paid[0]['paid_due']-$indoor_adm_fee_income[0]['admission_fee_paid'];
// echo $due;
  ...
  $t_c_in+=$indoor_net_income[0]['paid_due']-$indoor_due_collection[0]['paid_due'];
  ...
  $t_d_c_in+=$indoor_due_collection[0]['paid_due'];
  ...
  <tr >
    <td align="left">5</td>
    <?php if($total_n_i-$indoor_total_paid[0]['paid_due']-$indoor_adm_fee_income[0]['admission_fee_paid'] >= 0){ ?>
     <td>Total Indoor Due (-)</td>
     <td align="right" ><?=number_format($total_n_i-$indoor_total_paid[0]['paid_due']-$indoor_adm_fee_income[0]['admission_fee_paid'], 2, '.', '');?></td>

   <?php } else{ 
     $temp_val=($total_n_i-$indoor_total_paid[0]['paid_due']-$indoor_adm_fee_income[0]['admission_fee_paid'])*(-1);
     ?>

     <td>Total Indoor Advance (+)</td>
     <td align="right" ><?=number_format($temp_val, 2, '.', '');?></td>
...
<!--    <tr >
    <td align="left">5</td>
    <td align="left">Indoor Net Income</td>
    <td align="right" style="border-top: 3px solid #000 !important;"><?=number_format($total_n_i, 2, '.', '');?></td>
...
<tr>
  ...
  <td align="right"><?=number_format($indoor_net_income[0]['paid_due']-$indoor_due_collection[0]['paid_due']-$indoor_advance_payment[0]['advance_payment']-$indoor_adm_fee_income[0]['admission_fee_paid'], 2, '.', '');?></td>
</tr> 

<tr>
  <td align="left">9</td>
  <td align="left">Indoor Current Collection<br><span>(including adm & adv fee)</span></td>
  <td align="right" style="border-top: 3px solid #000 !important;"><?=number_format($indoor_net_income[0]['paid_due']-$indoor_due_collection[0]['paid_due'], 2, '.', '');?></td>
</tr> 
...
<tr>
  ...
  <?php  $t_d_c+=$indoor_net_income[0]['paid_due']-$indoor_total_paid[0]['paid_due']; ?>
...
<!-- 
    ...
    <tbody>
      ...
      $total_n_i+=$indoor_diag_total_amount[0]['total_amount']+$indoor_diag_vat_income[0]['vat']-$indoor_diag_discount_expense[0]['total_discount'];
      ...
      $t_f_d+=$indoor_diag_discount_expense[0]['total_discount'];
      ...
      <tr >
        ...
        <td align="right"><?=number_format($indoor_diag_discount_expense[0]['total_discount'], 2, '.', '');?></td>
...
<!--        <tr>
         ...
         <?php if($t_d_in >= 0){ ?>
           <td>Total Indoor Due (-)</td>
           <td align="right" ><?=number_format($t_d_in, 2, '.', '');?></td>
       ...
       <tr>
         ...
         <td align="right"><?=number_format($t_d_c_in, 2, '.', '');?></td>
