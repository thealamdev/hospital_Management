...
<body style="color:#000; text-align: center;">
  ...
  <table class="farhana-table-2">
    <tr>
     ...
     <td   class="table-1-col-1"><p><?=$flag?> RECEIPT</p></td>
     <td   class="table-1-col-1"></td>
   </tr>
 </table>


 <table style="padding-top:20px;  margin-left:5px; width:230px; text-align: center;font-size:12px; float: left;">

   <tr>
     <th style="text-align: left"><b>Head Name :</b> <span style="font-weight:normal"><?=$income_info[0]['acc_head_title'];?></span></th>
   </tr>

   <tr>
     <th style="text-align: left">Code: <span style="font-weight:normal"><?=$income_info[0]['acc_head_code'];?></span></th>
   </tr>

   <tr>
     <th style="text-align: left">Date: <span style="font-weight:normal"><?=date('d M,Y h:i a',strtotime($income_info[0]['created_at']))?></span></th>
   </tr>
 ...
 <table style="padding-top:20px;  margin-left:5px; width:230px; text-align: center;font-size:12px">
   ...
   <tr>
     <th style="text-align: left"><b>Ref:</b> <span style="font-weight:normal"><?=$income_info[0]['inc_exp_ref'];?></span></th>
   </tr>

   <tr>
     <th style="text-align: left">Challan: <span style="font-weight:normal"><?=$income_info[0]['challan_no'];?></span></th>
   </tr>
 ...
 <table style="text-align:center; border-collapse: collapse;font-size: 12px; width:400px; margin-left:10px; margin-top:20px;margin-bottom:20px" class="table">
  <thead>
    <tr>
      ...
      <th style="border: #000 solid 1px;text-align:center;padding:0px 15px">Purpose</th>

      <?php if($flag=="ASSET") {?>
      <th style="border: #000 solid 1px;text-align:center;padding:0px 15px">Per Amount</th>
      <th style="border: #000 solid 1px;text-align:center;padding:0px 15px">Qty</th>
...
<tbody>
 <?php foreach ($income_info as $key => $row) { ?>
   <tr>
     <td align="" style="border: #000 solid 1px;"><?=$key+1;?></td>
     <td align="" style="padding:0px!important;border: #000 solid 1px;"><?=$row['income_expense_purpose'];?></td>
     <?php if($flag=="ASSET") ?>

     <td align="" style="padding:0px!important;border: #000 solid 1px;"><?=$row['per_amount'];?></td>
...
<table style="text-align:left; border-collapse: collapse;font-size: 12px; width:400px; margin-left:10px; margin-top:20px;margin-bottom:20px">
  <tr>
    <td rowspan="6" class="tranform-text" ><span><label id="payment_status"></label></span></td>
    <td><b>Total Amount </b>: <?=$income_info[0]['total_paid']?></td>
