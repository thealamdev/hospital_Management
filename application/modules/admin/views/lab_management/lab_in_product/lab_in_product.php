...
<body class="light">
  ...
  <div id="app">
   ...
   <div class="page has-sidebar-left height-full">
    ...
    <div class="section-wrapper">
      ...
      <div class="card my-3 no-b">
        <div class="card-body">
          ...
          <div class="row">
            <form  action="admin/insert_lab_in_product" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group focused">
                      <input type="text" name="purchase_date" class="date-time-picker form-control" data-options="{&quot;timepicker&quot;:false, &quot;format&quot;:&quot;Y-m-d&quot;}" value="<?=date('d-m-Y');?>" required>
    ...
    <script type="text/javascript">
     ...
     $.ajax({  
      url:"<?=site_url('admin/get_last_lab_bill_no')?>",  
      method:"POST",  
      dataType:"json",  
  ...
  <script>
    ...
    function get_product_data(id)
    {
      ...
      $.ajax({
        type: 'POST',
        url: "<?=base_url();?>admin/get_lab_product_details_ajax",
        data: {p_id: p_id},
        dataType: 'json',
        success: function (data) 
        {
