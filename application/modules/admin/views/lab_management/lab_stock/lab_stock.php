  ...
  <div class="has-sidebar-left">
    ...
    <div class="page has-sidebar-left height-full">
        ...
        <div align="right" class="mt-3 mr-3">
          <button onclick="lab_stock_report_pdf()" class="btn btn-lg  btn-default"><i class="icon icon-cloud-download"></i> Pdf</button>
        </div>  
            ...
            <div class="card-body">
					...
					<!-- </form>				 -->
									<div class="col-md-2">
										...
										<a href="javascript:void(0)" onclick="get_lab_stock_chart()" class="btn btn-white btn-primary btn-bold">
	...
	function get_lab_stock_chart() 
		{
			...
			var p_id=$("#p_id").val();
				...
				$.ajax({
					      type: 'POST',
					      cache: false,
					      url: "<?=base_url();?>admin/get_lab_stock_chart",
		...
		function lab_stock_report_pdf(argument) {
			...
			window.open('<?=base_url();?>admin/lab_stock_details_pdf/'+from_date+'/'+to_date+'/'+p_id,'_blank','width=560,height=340,toolbar=0,menubar=0,location=0');
