          ...
          <div class="row"> 
                  <div class="col-md-4 offset-md-4 form-group">
                    ...
                    <div class="fileinput-new thumbnail" style="width: 120px; height: 80px;background: white">
                      <img src="uploads/lab_product_image/<?=$all_product_info[0]['p_img']?>" alt="...">
                    </div>
           ...
           <!--         <div class="col-md-6 form-group">
                    ...
                    <select class="custom-select select2 form-control" name="p_pack_size" id="p_pack_size" required>
                       ...
                       <?php 
                                            foreach ($all_pack_size as $key => $pack){if($pack['id']==$all_product_info[0]['pack_size_id']){
                                             ?>
                                                  <option selected value="<?=$pack['id']?>"><?=$pack['pack_size']?></option>
