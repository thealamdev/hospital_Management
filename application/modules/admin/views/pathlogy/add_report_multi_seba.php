...
<body class="light">
									...
									<div class="group_input">
										<select name="checked_by" class="form-control">
											<?php foreach ($tecnology_info as $tecnology) { ?>
												...
												<option value="<?php echo $tecnology['id'] ?>"><?php echo ($tecnology['prepared_by_name'] ? $tecnology['prepared_by_name'] : $tecnology['technologist_name'])   ?></option>
											<?php }  ?>
										</select>
									</div>
 ...
 <?php
  ...
  <!-- width: 700px !important;
      ...
      display: flex !important;
      justify-content: space-between !important; -->
      <div style="width:100%;margin:0 auto;text-align:center;font-size:20px;font-weight:700;padding-bottom:10px;font-family: Verdana,Geneva,sans-serif;margin-top: 115px;">  
<?php echo $test_title ?>
</div>
 <div class="details_table_wrapper"style="font-size: 14px;font-family: Verdana,Geneva,sans-serif;">
   <div style="width:100%;margin:0 auto;display:flex;justify-content: space-between !important;box-sizing:border-box;">
     <div  style="width:55%">
	 ...
	 <!-- <div style="width: 34%;">
   <div><p style="display: inline-block;width:80px">Invoice No.</p> <p style="display: inline-block;">: <?php echo $order_info[0]['test_order_id'] ?></p></div>
   </div> -->
...
<table class="wrapper_table" style="width:100%;font-family: Verdana,Geneva,sans-serif;font-size: 14px;">
 <thead>
