<div id="editor">
  ...
  <table class="farhana-table-5" style="width: 700px !important;">

    <div><img src="<?= base_url(); ?>back_assets/doc_sign_1.jpg" alt="" /></div>

    <!-- <div  align="right"><h2>Medical Officer</h2></div> -->
