                ...
                <form method="POST" action="admin/search_pathology_list_custom">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" autocomplete="off" id="order_id" name="order_id" class="form-control">
                    </div>
                  </div>

                  <div class="btn_submit m-auto">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><?php if ($value['is_multi_print'] == 1) {
                            echo '<span class="badge badge-danger">Printed</span>';
                          } else {
                      ...
                      <td style="display:none">
                        <div class="group_report"><textarea id="group_report_<?= $p_test_id ?>" name="group_report[]"></textarea></div>
                      </td>
                ...
                <div class="col-lg-4 m-auto">
                  <div class="details_info">
                    <?php if ($value['is_multi_print'] == 3) { ?>
                      ...
                      <a class="form-control btn btn-danger" href="admin/dlt_old_combine_report/<?= $value['order_id'] ?>">Delete Old Combine Report</a>

                    <?php } ?>
                    <?php if ($value['payment_status'] == "paid") { ?>
                      <button class="form-control btn btn-success" type="submit">Create Combine Report</button>
