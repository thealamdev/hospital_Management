...
<div id="app">
  ...
  <?php echo validation_errors(); ?>         
        <div class="section-wrapper">
            ...
            <div class="card-body">
              <div class="container">
                <form action="admin/add_operation_post" method="POST" class="ipd_form">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="form-group">
                                ...
                                <div class="col-md-8"><input class="form-control form-control-sm"  type="text" name="operation_name" placeholder="Operation Name" required></div>
                                </div>
                            </div>
                     <div class="form-group">
                                <div class="row">
                                    <label for="" class="col-md-4 text-right">Price</label>
                                <div class="col-md-8"><input class="form-control form-control-sm"   type="text" name="operation_price" placeholder="Price" required></div>
                                </div>
                            </div>
