...
<?php if ($service_info != null ) {?>
  ...
  <table class="farhana-table-2">
    <tr>
     ...
     <td   class="table-1-col-1"><p >Expense Report</p></td>
     <td   class="table-1-col-1"></td>
   </tr>
 </table>
 ...
 <table style="padding-top:20px;  margin-left:5px; width:230px; text-align: center;font-size:12px ">
  <tr>
   <th style="text-align: left"><b>Patient Id :</b> <span style="font-weight:normal"><?=$service_info[0]['patient_info_id'];?></span></th>
 </tr>

 <tr>
   <th style="text-align: left"><b>Patient Name :</b> <span style="font-weight:normal"><?=$service_info[0]['patient_name'];?></span></th>
 </tr>

 <tr>
   <th style="text-align: left">Invoice No: <span style="font-weight:normal"><?=$service_info[0]['invoice_order_id'];?></span></th>
 </tr>

 <tr>
   <th style="text-align: left">Date: <span style="font-weight:normal"><?=date('d M,Y h:i a',strtotime($service_info[0]['created_at']))?></span></th>
 </tr>
 ...
 <table style="text-align:center; border-collapse: collapse;font-size: 12px; width:400px; margin-left:10px; margin-top:20px;margin-bottom:20px" class="table">
  <thead>
    <tr>
      ...
      <th style="border: #000 solid 1px;text-align:left;padding:0px 15px">Expense Purposes</th>
      <th style="border: #000 solid 1px;text-align:left;padding:0px 15px">Amount</th>
    </tr>
  </thead>
  <tbody>
   <?php 
   ...
   foreach ($service_info as $key => $row) { 
    ...
    ?>
     <tr>
       ...
       <td align="" style="border: #000 solid 1px;"><?=$row['service_price'];?>
     </td>
   </tr>
 <?php } ?>
</tbody>
...
<div style=" padding-bottom:10px" class="row">
 ...
 <tr>
   ...
   $due= $total_amount-$cost_paid+$discount;
                         // echo $due;
   if($due <= 0)
   {
...
<tr>
  ...
  <td style="text-align: left">  : <?=number_format($discount,2);?>&nbsp;৳</td>
</tr>

<tr>
  <th style="text-align: left"><b>Net Amount </b></th>
  <td style="text-align: left">  : <?=number_format($total_amount-$discount,2);?>&nbsp;৳</td>
</tr>

<tr>
  <th style="text-align: left;border-bottom:1px solid #ebebeb;"><b>Amount Paid</b></th>
  <td style="text-align: left">  :  <?=number_format($cost_paid,2);?> &#x9f3</td>
</tr>
...
<h3 style="text-align: center;">No service by any doctor</h3>
