                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                    <form action="admin/edit_ipd_bill/" method="POST">
                                       <select class="custom-select select2 form-control" onchange="this.form.submit()" name="patient_id"  id="patient_id" required>
