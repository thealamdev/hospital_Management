        ...
        <div class="card-body">
          ...
          <thead>
            <tr>
              ...
              <th style="width:10%;">Serv. By OPD</th>
              <th style="width:10%;">Status</th>
              <th style="width:10%;">Action</th>
              <th style="width:10%;">Admit Date</th>
              <th style="width:10%;">Rel. Date</th>
              <th style="width:10%;">Edit</th>
              <th style="width:10%;">Delete</th>
              <th style="width:10%;">Op. Cost Det.</th>
              <th style="width:10%;">Op. Det. (Print)</th>
   ...
   <script type="text/javascript" language="javascript" >  
     $(document).ready(function(){ 
      ...
      var dataTable = $('#test_table').DataTable({  
       ...
       "order":[],  
       "ajax":{  
        url:"<?php echo base_url()?>"+'admin/ipd_patient_billing_list_all_dt/all/<?=$uhid?>',  
        type:"POST"
      },  
      "columnDefs":[  
      {  
