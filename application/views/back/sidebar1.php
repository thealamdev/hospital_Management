 ...
 <section class="sidebar">
   ...
   <?php if($role==0){ ?>
      ...
      <?php if(($this->auth->can('test_group-admin')) || $this->auth->can('operation_list-admin') || $this->auth->can('service_list-admin') || ($this->auth->can('add_specimen-admin')) || ($this->auth->can('add_user-admin')) || ($this->auth->can('user_list-admin'))){?>
         ...
         <li class="treeview <?php if($active=='test_group'||$active=='add_user'||$active=='add_hospital'||$active=='add_hospital_form'){echo 'active';}?>">
            <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Manage<i
               ...
               <ul class="treeview-menu <?php if($active=='test_group'||$active=='add_user'||$active=='add_hospital'||$active=='add_hospital_form'){echo 'menu-open display_block';}?>">
                  ...
                  <?php } ?>
                  <?php if(($this->auth->can('operation_list-admin'))){?>
...
<?php if(($this->auth->can('role_list-admin')) || ($this->auth->can('add_user-admin')) || ($this->auth->can('user_list-admin'))){ ?>
   ...
   <?php if(($this->auth->can('doc_schedule_list-admin')) || ($this->auth->can('appointment_list-admin')) || ($this->auth->can('attendant_list-admin'))){?>
      ...
      <li class="treeview <?php if($active=='test_group'||$active=='add_user'||$active=='add_hospital'||$active=='add_hospital_form'){echo 'active';}?>">
         <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Manage Appointment<i
            ...
            <ul class="treeview-menu <?php if($active=='test_group'||$active=='add_user'||$active=='add_hospital'||$active=='add_hospital_form'){echo 'menu-open display_block';}?>">
               ...
               <?php } ?>
               <?php if(($this->auth->can('attendant_list-admin'))){?>
      ...
      <?php } if(($this->auth->can('add_doc-admin')) || ($this->auth->can('all_doc_list-admin'))){?>
         ...
         <?php } if(($this->auth->can('show_all_opd_patient-admin')) || ($this->auth->can('show_all_paid_opd_patient-admin')) || ($this->auth->can('show_all_unpaid_opd_patient-admin')) || ($this->auth->can('opd_registration-admin')) ||
            ...
            ($this->auth->can('opd_today_com_list-admin')) ||
            ($this->auth->can('outdoor_due_collection-admin')) ||
...
<?php } if(($this->auth->can('opd_collection-admin')) || ($this->auth->can('head_list-admin'))||
   ...
   ($this->auth->can('expense_list-admin'))){?>
      ...
      <li class="treeview">
         <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Outdoor Accounts<i
            class="icon icon-angle-left s-18 pull-right"></i></a>
            <ul class="treeview-menu <?php if($active=='opd'||$active=='opd_patient_list'){echo 'menu-open display_block';}?>">
               <?php if(($this->auth->can('opd_collection-admin'))){?>
      ...
      <?php } if(($this->auth->can('ipd_registration-admin')) ||($this->auth->can('ipd_all_patient_list-admin'))||
   ...
   <?php } if(($this->auth->can('ipd_summary_day_wise-admin')) || ($this->auth->can('income_list-admin')) ||
      ($this->auth->can('expense_list-admin'))|| ($this->auth->can('date_wise_indoor_collection-admin'))||
      ($this->auth->can('date_wise_balance_sheet-admin'))||
...
<?php } if(($this->auth->can('technologist_list-admin')) || ($this->auth->can('testlist-admin'))||
   ($this->auth->can('pathology_list-admin'))||
   ($this->auth->can('search_pathology-admin'))){?>
      ...
      <li class="treeview <?php if($active=='ipd_registration' || $active=='ipd_patient_list' || $active == 'patient_details' || $active == 'ipd_billing' || $active == 'cabin_transfer' ){echo 'active';}?>">
         ...
         <?php } if(($this->auth->can('add_customer-admin')) || ($this->auth->can('product_list-admin'))||
            ...
            ($this->auth->can('add_product_invoice-admin'))||
            ($this->auth->can('stock-admin'))||
            ($this->auth->can('product_stock-admin'))||
            ($this->auth->can('company_stock-admin')) || ($this->auth->can('add_supplier-admin'))|| ($this->auth->can('add_unit-admin'))||($this->auth->can('add_gen-admin')) || ($this->auth->can('add_pro_cat-admin')) || ($this->auth->can('add_com-admin')) ||
                     ...
                     <li>
                        ...
                        <ul class="treeview-menu <?php if($active=='pharmacy'){echo 'menu-open display_block';}?>">
                           ...
                           <?php if(($this->auth->can('sell_product_list-admin'))){?>
                              <li><a href="admin/sell_product_list"><i class="icon icon-circle-o"></i>Sell Product List</a></li>
                           <?php } ?>
                           <?php if(($this->auth->can('purchage_product_list-admin'))){?>
                              <li><a href="admin/purchage_product_list"><i class="icon icon-circle-o"></i>Purchase Product List</a></li>
                           <?php } ?>
                           ...
                           <?php } ?>
                           <?php if(($this->auth->can('add_product_invoice-admin'))){?>
            ...
            <?php } if(($this->auth->can('dir_wise_collection-admin')) || ($this->auth->can('day_wise_collection_pharmacy-admin'))
               ||($this->auth->can('date_wise_balance_sheet-admin'))||
               ($this->auth->can('head_list-admin')) || ($this->auth->can('income_list-admin'))||
               ($this->auth->can('expense_list-admin'))){?>
                  ...
                  <li class="treeview">
                     ...
                     <?php } if(($this->auth->can('head_list-admin')) || ($this->auth->can('income_list-admin'))||
                        ($this->auth->can('expense_list-admin'))||
                        ($this->auth->can('asset_list-admin'))||
                        ($this->auth->can('other_asset_report-admin'))||
                        ($this->auth->can('other_expense_report-admin'))||
                        ($this->auth->can('other_income_report-admin')) || ($this->auth->can('date_wise_balance_sheet-admin'))||
                        ($this->auth->can('sell_product_list-admin'))||
                        ($this->auth->can('purchage_product_list-admin'))){?>
                              ...
                              <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Accounts Management<i
                                 ...
                                 <ul class="treeview-menu">
                                    ...
                                    <?php if(($this->auth->can('asset_list-admin'))){?>
                                       <li><a href="admin/asset_list"><i class="icon icon-circle-o"></i>Asset List</a>
                                       </li>
                                    <?php } ?>
...
<?php } if(($this->auth->can('ipd_collection_day_wise-admin')) ||($this->auth->can('ipd_collection_service_wise-admin'))||
($this->auth->can('date_wise_balance_sheet-admin')) ){?>
   ...
   <li class="treeview">
      <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Indoor Accounts<i
         class="icon icon-angle-left s-18 pull-right"></i></a>
         <ul class="treeview-menu <?php if($active=='opd'||$active=='opd_patient_list'){echo 'menu-open display_block';}?>">
            <?php if(($this->auth->can('ipd_collection_day_wise-admin'))){?>
               <li><a href="admin/ipd_collection_day_wise"><i class="icon icon-circle-o"></i>Indoor Day Wise Collection</a>
               </li>
            <?php } ?>
            <?php if(($this->auth->can('ipd_collection_service_wise-admin'))){?>
               <li><a href="admin/ipd_collection_service_wise"><i class="icon icon-circle-o"></i>Indoor Service Wise Collection </a>
               </li>
            <?php } ?>
            <?php if(($this->auth->can('date_wise_balance_sheet-admin'))){?>
   ...
   <?php } if(($this->auth->can('opd_collection-admin')) || ($this->auth->can('date_wise_balance_sheet-admin'))){?>
      ...
      <li class="treeview">
         ...
         <?php } if(($this->auth->can('doc_wise_collection-admin'))|| ($this->auth->can('date_wise_balance_sheet-admin'))){?>            
            <li class="treeview">
               <a href="javascript:void(0)"><i class="icon icon-account_box light-green-text s-18"></i>Pharmacy Accounts<i
                  class="icon icon-angle-left s-18 pull-right"></i></a>
                  <ul class="treeview-menu <?php if($active=='opd'||$active=='opd_patient_list'){echo 'menu-open display_block';}?>">
                     <?php if(($this->auth->can('doc_wise_collection-admin'))){?>
