<?php
 ...
 <section class="sidebar" style="background:#2B3467">
   ...
   <div class="relative">
     ...
     <div class="user-panel p-3 light mb-2 " style="background: #2B3467;">
       <div>
         ...
         <div class=" info">
           <h3 style="color:#fff; font-weight: 500; text-align: center;" class=" mt-2 mb-1">
       ...
       <div class="collapse multi-collapse" id="userSettingsCollapse">
         <div class="list-group mt-3 shadow">
           <a href="admin/change_password/<?php echo $user_id ?>" class="list-group-item list-group-item-action"><i class="mr-2 icon-security text-purple"></i>Change Password</a>
         </div>
       </div>
     </div>
   </div>
   ...
   <ul class="sidebar-menu">
     ...
     <li class="treeview"><a href="admin" class="<?php if ($active == 'dashboard') {
                                                    echo 'active';
                                                  } ?>">
     ...
     <?php if ($role == 0) { ?>
       ...
       <li class="treeview <?php if ($active == 'test_group' || $active == 'add_user' || $active == 'add_hospital' || $active == 'add_hospital_form') {
         ...
         <a href="javascript:void(0)"><i class="fa fa-lock icon-sidebar"></i> <span>Super Admin Area</span> <i class="icon icon-angle-left s-18 pull-right"></i></a>
     ...
     <?php } else { ?>
       ...
       <?php if ($this->auth->can('add_doc-admin') || $this->auth->can('all_doc_list-admin') || $this->auth->can('assign_doc_comission_view_list-admin')) { ?>
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>Doctor Management</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'doc') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if ($this->auth->can('uhid_reg_list-admin') || $this->auth->can('uhid_reg-admin')) { ?>
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>UHID Management</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'doc') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if ($this->auth->can('add_birth_certificate-admin') || $this->auth->can('uhid_reg-admin')) { ?>
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>Birth/Death Certificate</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'doc') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if (
          $this->auth->can('show_all_opd_patient-admin') ||
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-building icon-sidebar"></i> <span>Outdoor</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'opd' || $active == 'opd_patient_list') {
                                      echo 'menu-open display_block';
                                    } ?>">
             <?php if (
                $this->auth->can('show_all_opd_patient-admin') ||
               ...
               <li>
                 ...
                 <ul class="treeview-menu <?php if ($active == 'opd_patient_list') {
                                            echo 'menu-open display_block';
                                          } ?>">
       ...
       <?php if (
          $this->auth->can('opd_today_collection-admin') ||
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-server icon-sidebar"></i> <span>Outdoor Accounts</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'opd' || $active == 'opd_patient_list') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if ($this->auth->can('cabin_class_room_list-admin') || $this->auth->can('indoor_cabin_summary-admin')) { ?>
         ...
         <li class="treeview <?php if ($active == 'cabin_class_room_list') {
                                echo 'active';
                              } ?>">
           ...
           <ul class="treeview-menu <?php if ($active == 'cabin_class_room_list') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if (
          $this->auth->can('ipd_registration-admin') ||
         ...
         <li class="treeview <?php if ($active == 'ipd_registration' || $active == 'ipd_patient_list' || $active == 'patient_details' || $active == 'ipd_billing' || $active == 'cabin_transfer') {
                                echo 'active';
                              } ?>">
           <a href="javascript:void(0)"><i class="fa fa-cube icon-sidebar"></i> <span>Indoor</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'ipd_registration') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if (
          $this->auth->can('ipd_summary_day_wise-admin') ||
         ...
         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-server icon-sidebar"></i> <span>Indoor Accounts</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'opd' || $active == 'opd_patient_list') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php if (
          $this->auth->can('technologist_list-admin') ||
         ...
         <li class="treeview <?php if ($active == 'ipd_registration' || $active == 'ipd_patient_list' || $active == 'patient_details' || $active == 'ipd_billing' || $active == 'cabin_transfer') {
           ...
           <a href="javascript:void(0)"><i class="fa fa-print icon-sidebar"></i> <span>Pathology Report</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'ipd_registration') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php
        ...
        if (
          $this->auth->can('add_customer-admin') ||
         ...
         <li class="treeview">
           ...
           <ul class="treeview-menu <?php if ($active == 'pharmacy') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <?php }
        if (
          $this->auth->can('dir_wise_collection-admin') ||
          $this->auth->can('day_wise_collection_pharmacy-admin') ||
          $this->auth->can('date_wise_balance_sheet_phar-admin')
        ) { ?>

         <li class="treeview">
           <a href="javascript:void(0)"><i class="fa fa-server icon-sidebar"></i> <span>Pharmacy Accounts</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu <?php if ($active == 'opd' || $active == 'opd_patient_list') {
                                      echo 'menu-open display_block';
                                    } ?>">
       ...
       <li class="treeview">
         ...
         <ul class="treeview-menu <?php if ($active == 'lab') {
                                    echo 'menu-open display_block';
                                  } ?>">

           <?php if (
              $this->auth->can('lab_product_list-admin') ||
       ...
       <?php if (
         ...
         <li class="treeview <?php if ($active == 'Acc_head') {
                                echo 'active';
                              } ?>">
           <a href="javascript:void(0)"><i class="fa fa-cog icon-sidebar"></i> <span>Accounts Management</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
       ...
       <!-- Manage HR Starts-->
       <?php if (
          $this->auth->can('add_staff_designation-admin') || $this->auth->can('all_staff_designation_list-admin') || $this->auth->can('staff_registation-admin') ||
         ...
         <li class="treeview <?php if ($active == 'HR_head') {
                                echo 'active';
                              } ?>">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>HR Management</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu">
       ...
       <?php if (
          $this->auth->can('ambulance_receipt_registation-admin') ||
          $this->auth->can('add_ambulance-admin') ||
          $this->auth->can('ambulance_list-admin') ||
          $this->auth->can('ambulance_receipt_list-admin')
        ) { ?>

         <li class="treeview <?php if ($active == 'Ambulance_head') {
                                echo 'active';
                              } ?>">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>Ambulance Managment</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu">
       ...
       <?php if (
          $this->auth->can('emergency_receipt_registation-admin') ||
          $this->auth->can('emergency_receipt_list-admin')
        ) { ?>

         <li class="treeview <?php if ($active == 'Emergency_head') {
                                echo 'active';
                              } ?>">
           <a href="javascript:void(0)"><i class="fa fa-user-md icon-sidebar"></i> <span>Emergency Managment</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu">
       ...
       <?php if (
         ...
         <li class="treeview <?php if ($active == 'Acc_head') {
           ...
           <a href="javascript:void(0)"><i class="fa fa-cog icon-sidebar"></i> <span>All Reports</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
           <ul class="treeview-menu">
     ...
     <?php if ($this->auth->can('add_share_holder-admin') || $this->auth->can('share_holder_type-admin')) { ?>
       ...
       <li class="treeview <?php if ($active == 'Acc_head') {
                              echo 'active';
                            } ?>"><a href="javascript:void(0)"><i class="fa fa-male icon-sidebar"></i></i>Manage Share Holder<i class="icon icon-angle-left s-18 pull-right"></i></a>
         <ul class="treeview-menu">
